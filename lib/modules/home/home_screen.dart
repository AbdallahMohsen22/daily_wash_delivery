            ...
            return RefreshIndicator(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ConditionalBuilder(
                      condition: SettingsCubit.get(context).deliveryModel != null,
                        ...
                        slivers: [
                          SliverToBoxAdapter(
                            child: ConditionalBuilder(
                              condition:cubit.orderModel2!=null,//cubit.val == 'new_orders'?cubit.orderModel!=null: ,
                              ...
                              builder: (context)=> ConditionalBuilder(
                                  ...
                                  //     :
                                  cubit.orderModel2!.data!.data!.isNotEmpty,
                                  fallback: (context)=>ConditionalBuilder(
                                    condition: appStates is! OrderLoadingState,
                                    fallback: (context)=>OrderListShimmer(),
                                    builder: (context)=> ListIsEmpty('no_orders_yet'),
                                  ),
                                  builder: (context){
                                    ...
                                    //     :
                                      cubit.orderModel2!.data!.data!.length,
